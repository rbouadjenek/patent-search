...
\begin{figure}[t!]
\begin{centering}
\subfigure[Oracular Query performance versus the threshold $\tau$.\label{fig:oracularpq-a}]{\includegraphics[width=6cm]{figs/oracularquery-map.eps}} 
\hspace*{1.5cm} \subfigure[Oracular Query performance versus the query size.\label{fig:oracularpq-b}]{\includegraphics[width=6cm]{figs/oracularquery-recall.eps}} 
\par\end{centering} 
\protect\caption{Oracular Query performance versus various values of the threshold $\tau$ and query size}

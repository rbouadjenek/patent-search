...
\begin{figure}[t!]
\begin{centering}
\subfigure[Optimal RF query performance versus the score threshold to select optimal query terms.]{\includegraphics[width=6cm]{figs/oracularq.eps}} \hspace*{1.5cm} \subfigure[Optimal RF query performance versus the query size.]{\includegraphics[width=6cm]{figs/oracularq-size.eps}} 
\par\end{centering} 
\protect\caption{Comparing the optimal query performance versus the $score_{RF}$ threshold and query size}
\label{fig:usefulnoisy}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
that contains 2.6 million patent documents and 1348 topics (queries) for the English test set.
...
and Okapi BM25) and exploits patent metadata and citation structures.  We compare our results with their results for the English topic subset as reported in \cite{piroi2010clef}.

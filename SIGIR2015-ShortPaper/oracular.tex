...
CLEF-IP 2010. Roughly 50\% improvement for the recall is achieved with respect to the baseline \textit{Patent Query}. The results also show that BM25 and LM perform very close to each other and they have the same trend.

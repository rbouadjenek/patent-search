...
MAP begins to improve over the baseline when we prune noisy words out of the \emph{Patent Query} by increasing the value of $\tau$, and it reaches the highest value at $\tau=1$.}

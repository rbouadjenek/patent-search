...
\par\end{centering}
\begin{centering}
\subfigure[{Mean Average Precision.}]{\includegraphics[width=4.5cm, height=3.5cm]{imgs/fig2_map}}\subfigure[Recall.]{\includegraphics[width=4.5cm, height=3.5cm]{imgs/fig2_recall}}
\par\end{centering}
\vspace*{-3ex}
\protect\caption{System performance vs. the threshold $\tau$ for four query reduction approaches.}
\label{fig:queryreduc}

...
public class PatentsStopWords {
    ...
    static {
        final List<String> stopWords = Arrays.asList(
                ...
                "would", "would", "wouldn't", "x", "y", "yes", "yet",
                "you", "you'd", "you'll", "you're", "you've", "your", "yours",
                "said", "claim", "wherein", "according", "one", "from", "means", "which", "first", "second", "method", "comprising", "least", "claims", "having", "each", "any", "c", "characterized", "comprises", "device", "group", "signal", "being", "data", "system", "between", "further", "apparatus", "claimed", "surface", "portion", "selected", "n", "process", "end", "material", "r", "characterised", "member", "plurality", "has", "about", "control", "acid", "layer", "step", "composition", "compound", "alkyl", "b", "position", "two", "than", "element"
        );
        final CharArraySet stopSet = new CharArraySet(Version.LUCENE_48, stopWords, false);

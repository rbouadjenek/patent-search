...
//	public String outputfile = "./output/results/results-lmdir-desc-100.txt";
	public String outputfile = "./output/results/results-bm25-100.txt";/*"./output/results/results-lmj-1000-lamda0.7.txt";*/
...
/*-------------------------------------------------------------------------------*/
    ...
    public ExecuteTopics(String indexDir, String topicFile, int topK, String similarity, float titleBoost, float abstractBoost,
        ...
        if (startingPoint.equals("-1")) {
            ...
            if (rewrite) {
                System.out.print(" #termsImpactFilename: " + termsImpactFilename);
                System.out.println("");
            }
        }
        if (expansion) {
            ...
            switch (algo.toLowerCase()) {
                ...
                case "usynset":
                    ...
                    break;
                case "codeqr":
                    pqe = new PatentClassCodeBasedQueryReduction(classCodesIndexDir, nbrTerms);
                    if (startingPoint.equals("-1")) {

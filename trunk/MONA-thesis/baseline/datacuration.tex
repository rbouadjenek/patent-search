...
\begin{figure}[t!]
\begin{centering}
\subfigure[Cut-off rank ($k$) $= 100$\label{fig:datacuration_a}]{\includegraphics[width=6.5cm]{figs/analyseFNs100.eps}}  
\subfigure[Cut-off rank ($k$) $= 1,000$\label{fig:datacuration_b}]{\includegraphics[width=6.5cm]{figs/analyseFNs1000.eps}} 
\par\end{centering} 
...
%\begin{figure}[t!]
%\begin{centering}
%\subfigure[Cut-off rank(k) = 100\label{fig:datacuration_a}]{\includegraphics[width=6.5cm]{figs/analyseFNs100.eps}} \hspace*{0.5cm} 
%\subfigure[Cut-off rank(k) = 1000\label{fig:datacuration_b}]{\includegraphics[width=6.5cm]{figs/analyseFNs1000.eps}} 
%\par\end{centering} 

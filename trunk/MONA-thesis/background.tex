...
As it will be described in Section~\ref{sec:metadata}, IPC codes and citations has been widely applied in patent retrieval. 
\paragraph{(5) International Patent Classification Code}
\ \\ 
...
subclasses. Subclass C07C, for example, deals with ``Acyclic or Carbocyclic Compounds''. Subclasses are then further 

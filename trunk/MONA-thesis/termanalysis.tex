...
\protect\caption{Scatter plot of recall versus the existence of useful terms in query for different values of $\tau$.}
\label{fig:overlap-r}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\protect\caption{Scatter plot of average precision (AP) versus the existence of useful terms in query for different values of $\tau$.}
\label{fig:overlap-p}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[t!]
\begin{centering}
\includegraphics[width=9cm]{figs/l3.eps}
\par\end{centering}

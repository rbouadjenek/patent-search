...
\begin{centering}
\subfigure[{Mean Average Precision.}]{\includegraphics[width=4.5cm]{imgs/fig1_map}}\subfigure[Recall.]{\includegraphics[width=4.5cm]{imgs/fig1_recall}}
\par\end{centering}
...
MAP begins to improve over the baseline when we prune noisy words out of the \emph{Patent Query} by increasing the value of $\tau$; it approaches its highest value at $\tau=1$, where it starts decreasing due to losing useful words.}

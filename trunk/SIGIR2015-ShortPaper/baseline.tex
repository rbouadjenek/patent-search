...
%a subset of 1281 topics (queries) in the English test set where we determined at least one relevant English document was available.
...
is processed, \textcolor{black}{all indexed fields are targeted with an equal weight.}\cite{Bouadjenek2015}

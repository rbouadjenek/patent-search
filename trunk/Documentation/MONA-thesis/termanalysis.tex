...
\begin{centering}
\subfigure[{Mean Average Precision.}]{\includegraphics[width=4.5cm]{figs/olap-fns-all.eps}}\subfigure[Recall.]{\includegraphics[width=4.5cm]{figs/olap-tps-all.eps}}\subfigure[Recall.]{\includegraphics[width=4.5cm]{figs/olap-fps-all.eps}}
\par\end{centering}

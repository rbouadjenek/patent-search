...
\svnid{$Id$}
%\usepackage{prelim2e}
%\renewcommand{\PrelimWords}{Draft ccCopy \svnkw{Id}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Preamble
\title{\bf On Term Selection Techniques for Patent Prior Art Search}
\author{Mona Golestan Far\\{\small mona.golestanfar@anu.edu.au}}
\date{\today}

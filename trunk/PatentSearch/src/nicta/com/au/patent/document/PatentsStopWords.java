...
public class PatentsStopWords {
    ...
    static {
        final List<String> stopWords = Arrays.asList(
                ...
                "would", "would", "wouldn't", "x", "y", "yes", "yet",
                "you", "you'd", "you'll", "you're", "you've", "your", "yours",
                "from", "which", "invention", "can", "may", "fig", "one", "present", "c", "example", "used", "data", "each", "other", "has", "when", "also", "first", "shown", "signal", "figure", "acid", "between", "system", "described", "about", "n", "embodiment", "more", "having", "surface", "second", "were", "preferably", "above", "through", "m", "control", "means", "layer", "portion", "have", "using", "than", "two", "time", "material", "g", "device", "so", "method", "according", "end", "temperature", "s", "group", "water", "been", "d", "further", "b", "solution", "use", "step", "high", "provided", "after", "same", "process", "said", "preferred", "form", "its", "formed", "i", "any", "position", "number", "pressure", "h", "unit", "side", "type", "output", "weight", "thus", "being", "l", "light", "line", "within", "least", "mixture", "containing", "x", "include", "e.g", "added", "all", "apparatus", "value", "reference", "where", "obtained", "view", "another", "out", "amount", "al", "known", "set", "only", "provide", "t", "following", "operation", "part", "under", "flow", "made", "lower", "r", "liquid", "includes", "during", "base", "case", "product", "section", "connected", "direction", "however", "table", "over", "both", "structure", "like", "wherein", "different", "well", "block", "power", "body", "low", "art", "suitable", "metal", "thereof", "air", "while", "those", "processing", "order", "selected", "non", "p", "current", "shows", "up", "phase", "comprises", "level", "addition", "desired", "comprising", "range", "area", "point", "applied", "based", "examples", "prepared", "corresponding", "including", "generally", "state", "mm", "patent", "particular", "application", "rate", "length", "specific", "therefore", "less", "source", "without", "single", "e", "provides", "component", "possible", "below", "contact", "herein", "object", "various", "methods", "support", "three", "manner", "results", "result", "parts", "size", "upper", "accordance", "components", "materials", "along", "substantially", "conventional", "since", "elements", "conditions", "i.e", "either", "particularly", "field", "function", "cross", "respectively", "determined", "solid", "via", "some", "f", "required", "plurality", "because", "should", "ratio", "would", "defined", "figs", "embodiments", "upon", "forming", "prior", "most", "similar", "effect", "illustrated", "associated", "per", "thereby", "produced", "way", "resulting", "diameter", "small", "description", "showing", "portions", "available", "top", "found", "performed", "reduced", "typically", "values", "large", "u.s", "removed", "lines", "off", "given", "relative", "systems", "even", "devices", "figures", "higher", "third", "greater", "connection", "carried", "predetermined", "total", "against", "limited", "period", "due", "useful", "presence", "additional", "relates", "together", "free", "before", "new", "measured", "mounted", "does", "see", "general", "employed", "properties", "respective", "could", "generated", "necessary", "must", "change", "combination", "etc", "mentioned", "shape", "appropriate", "located", "next", "indicated", "now", "back", "fixed", "respect", "very", "placed", "approximately", "steps", "four", "attached", "increase", "produce", "aspect", "characteristics", "arranged", "effective", "standard", "relatively", "open", "adjacent", "operating", "disclosed", "although", "controlled", "contain", "times", "arrangement", "contains", "increased", "onto", "parallel", "many", "condition", "capable", "long", "taken", "comprise", "providing", "certain", "hand", "alternatively", "normal", "several", "until", "accordingly", "directly", "obtain", "equal", "need", "techniques", "specifically", "maximum", "drawings", "referring", "still", "improved", "previously", "around", "compared", "place", "sufficient", "forms", "detail", "incorporated", "applications", "combined", "seen", "down", "furthermore", "changes", "achieved", "referred", "opposite", "contained", "allow", "allows", "types", "separate", "common", "prevent", "especially", "skilled", "usually", "once", "cause", "do", "understood", "becomes", "them", "depending", "show", "follows", "larger", "make", "problem", "features", "short", "again", "included", "easily", "desirable", "alternative", "smaller", "intended", "making", "called", "therein", "reduce", "scope", "noted", "significant", "complete", "important", "become", "purpose", "occurs", "detailed", "causes", "typical", "apparent", "occur", "readily", "similarly", "increasing", "claims", "otherwise", "problems", "often", "discloses", "itself", "much", "instead", "advantages", "cannot", "achieve", "difficult", "accompanying", "modifications"
                ,  /* metric system units, symbols, and prefixes -mona*/
                "km", "m", "mm", "cm", "g", "mg" ,"kg", "t" , "s", "ms", "µs" , "A", "mA", "K", "mole",
                "mol", "cd", "°C", "m²", "ha", "km²", "mL", "L", "cm³", "m³", "m/s", "km/h", "kg/m³",	 	 	 
                "N", "kPa", "watt", "kilowatt",	"kW", "kJ", "MJ", "kW·h", "rad", "sr", "J/kg", "m/s²", "1/s",
        ...
        final CharArraySet stopSet = new CharArraySet(Version.LUCENE_48, stopWords, false);
        DESCRIPTION_ENGLISH_STOP_WORDS_SET = CharArraySet.unmodifiableSet(stopSet);
    }
    ...
    static {
        final List<String> stopWords = Arrays.asList(
                ...
                "would", "would", "wouldn't", "x", "y", "yes", "yet",
                "you", "you'd", "you'll", "you're", "you've", "your", "yours",
                "said", "claim", "wherein", "according", "one", "from", "means", "which", "first", "second", "method", "comprise", "comprising", "least", "claims", "having", "each", "any", "c", "characterized", "comprises", "device", "group", "signal", "being", "data", "system", "between", "further", "apparatus", "claimed", "surface", "portion", "selected", "n", "process", "end", "material", "r", "characterised", "member", "plurality", "has", "about", "control", "acid", "layer", "step", "composition", "compound", "alkyl", "b", "position", "two", "than", "element"
                ,  /* metric system units, symbols, and prefixes -mona*/
                "km", "m", "mm", "cm", "g", "mg" ,"kg", "t" , "s", "ms", "µs" , "A", "mA", "K", "mole",
                "mol", "cd", "°C", "m²", "ha", "km²", "mL", "L", "cm³", "m³", "m/s", "km/h", "kg/m³",	 	 	 
    ...
    static {
        final List<String> stopWords = Arrays.asList(
                ...
                "would", "would", "wouldn't", "x", "y", "yes", "yet",
                "you", "you'd", "you'll", "you're", "you've", "your", "yours", "method", "device", "apparatus", "system", "process"
               /* -------------merged abstarct stiopwords----------- -mona*/
                ,"a", "a's", "able", "about", "above", "according", "accordingly",
                "across", "actually", "after", "afterwards", "again", "against", "ain't",
                "all", "allow", "allows", "almost", "alone", "along", "already",
                "also", "although", "always", "am", "among", "amongst", "an",
        ...
        final CharArraySet stopSet = new CharArraySet(Version.LUCENE_48, stopWords, false);
        UNIFIED_PATENT__ENGLISH_STOP_WORDS_SET = CharArraySet.unmodifiableSet(stopSet);
    }

...
//			if(query.getDescLangOrMising().equals("missing")){miss++;}
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("-----------------------------------------------------------------------");
		System.out.println(" No." + "\t" + "QueryId" + "\t\t" + "En(%)" + "\t" + "N-En(%)" + "\t" + "miss(%)" + "\t" + "EN" + "\t" + "N-EN" + "\t" + "miss" + "\t" + "FN size");
		System.out.println("-----------------------------------------------------------------------");
		...
		for(String  q:topics.getTopics().keySet()){
			...
			if(k != 0){
				System.out.println("(" + n + ")\t" + q_queryId + "\t" + (float)en/k + "\t" + (float)nen/k + "\t" + (float)miss/k + "\t" + en + "\t" + nen + "\t" + miss + "\t" + k);
				ps.println("(" + n + ")\t" + q_queryId + "\t" + (float)en/k + "\t" + (float)nen/k + "\t" + (float)miss/k + "\t" + fns.size());
			}else {
				System.out.println("(" + n + ")\t" + q_queryId + "\t" + "0" + "\t" + "0" + "\t" + "0" + "\t" + "0" + "\t" + "0" + "\t" + "0" + "\t" + k);
				ps.println("(" + n + ")\t" + q_queryId + "\t" + "0" + "\t" + "0" + "\t" + "0" + "\t" + k);
			}
		}*/
	}

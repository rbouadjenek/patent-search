...
public class IPCcodeOverlap {
	...
	public void AnalyzeIPCOverlapAllQueries() throws IOException{

		/*--------------------------- Write in output file. -Mona ------------------------*/
		String outputfile = "./output/IPCOverlap/ipcoverlp-k100-2.txt";
		...
		for(Map.Entry<String, PatentDocument> topic : topics.getTopics().entrySet()){
			...
			System.out.println(queryid + "\t" + query_mainipc +"\t"+query.getIpc());
			String removed_qmainipc = query.getIpc().replace(query_mainipc, "");
			System.out.println(removed_qmainipc);
			System.out.println("----------------------------------------------");
...
//		overlap.AnalyzeIPCOverlapPerQuery();
		overlap.AnalyzeIPCOverlapAllQueries();

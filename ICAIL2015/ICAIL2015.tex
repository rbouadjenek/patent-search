...
% DOI
\doi{http://dx.doi.org/10.1145/2746090.2746092}
...
%Contribution ID: 5
\alignauthor
Mohamed Reda Bouadjenek$^{\dag}$\titlenote{This work has been primarily completed while the authors were at NICTA, Canberra, Australia.}, Scott Sanner$^{\Large \ddag \footnotemark[1]}$  , Gabriela Ferraro$^\S$\\
...
%Reda Bouadjenek\titlenote{This work has been primarily completed while the authors were at NICTA, Canberra, Australia.}\\
%       \affaddr{INRIA \& LIRMM}\\
%		\affaddr{Montpellier, France}\\
%       \affaddr{reda.bouadjenek@inria.fr}
%\alignauthor
%Scott Sanner$^{\Large \footnotemark[1]}$\\
%       \affaddr{Oregon State University}\\
%		\affaddr{Corvallis, USA}\\
%       \affaddr{scott.sanner@oregonstate.edu}
%\alignauthor
%Gabriela Ferraro\\
%       \affaddr{NICTA \& ANU}\\
%		\affaddr{Canberra, Australia}\\
%       \affaddr{gabriela.ferraro@nicta.com.au}
}
...
In 2014, 326,033 patent applications were approved in the US alone
...
and litigation. In 2014, 326,033 patent applications were approved
in the US alone\footnote{\texttt{http://www.uspto.gov/web/offices/ac/ido/oeip/taf/ us\_stat.htm}},
...
\begin{centering}
\subfigure[Title query.]{\includegraphics[width=4.2cm]{Results-CIKM2014/jaccard-qTitle-CLEF-IP2010}}\subfigure[Abstract query.]{\includegraphics[width=4.2cm]{Results-CIKM2014/jaccard-qAbstract-CLEF-IP2010}}
\par\end{centering}

\begin{centering}
\subfigure[Extended Abstract]{\includegraphics[width=4.2cm]{Results-CIKM2014/jaccard-qDescriptionP5-CLEF-IP2010}}\subfigure[Description query.]{\includegraphics[width=4.2cm]{Results-CIKM2014/jaccard-qDescription-CLEF-IP2010}}
...
of the average Jaccard similarity\footnote{The Jaccard similarity is used to measure the term overlap between
two sets. Before applying the Jaccard similarity, patent-specific
stop-words were removed, as suggested by \cite{Mahdabi2012}.} between different queries (representing the title, abstract, the
...
\section{Patent Query Reformulation}
...
query reduction for the abstract section of the Topic PAC-1019\footnote{\texttt{http://www.lens.org/lens/patent/WO\_2005\_100300\_A1}}
from the CLEF-IP 2010 data collection. The baseline query, which is
the original query (provided in the header row) after stemming and
stop-word removal , had an Average Precision (AP) of 0.280 and a Patent
Retrieval Evaluation Score (PRES)\footnote{The PRES metric places more emphasis on high-recall retrieval by weighting
relevant documents lower in the ranking more highly than MAP. } \cite{Magdy2010a} of 0.777 (its performance are provided in the
...
\begin{figure}[!h]
\centering{}\includegraphics[width=4.3cm]{analysis/precision-recall_ByField-CLEF-IP_2010}\includegraphics[width=4.3cm]{analysis/MAP-MRR_ByField-CLEF-IP_2010}
\protect\caption{The utility of query reduction for 1304 abstract queries of the CLEF-IP
2010 dataset. }
{\footnotesize{}\label{fig:QRUtility}}{\footnotesize \par}
\end{figure}
...
$\overrightarrow{Q'}$. We refer to this method as RocchioQE\footnote{We used the LucQE module, which provides an implementation of the
...
For our experiments, we used used the Lucene IR System\footnote{\texttt{http://lucene.apache.org/}}
to index the English subset of CLEF-IP 2010 and CLEF-IP 2011 datasets\footnote{\texttt{http://www.ifs.tuwien.ac.at/\textasciitilde{}clef-ip/}}
...
patent documents and CLEF-IP 2011 consists of 3 million patent documents.
The English test sets of CLEF-IP 2010 and CLEF-IP 2011 correspond
to 1303 and 1351 topics respectively.
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qTitle-MAP-CLEF-IP2010}}\subfigure[Query Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qAbstract-MAP-CLEF-IP2010}}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qExtAbstract-MAP-CLEF-IP2010}}\subfigure[Query Description.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qDescription-MAP-CLEF-IP2010}}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qTitle-PRES-CLEF-IP2010}
}\subfigure[Query Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qAbstract-PRES-CLEF-IP2010}
}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qExtAbstract-PRES-CLEF-IP2010}
}\subfigure[Query Description.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qDescription-PRES-CLEF-IP2010}
}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qTitle-MAP-CLEF-IP2011}}\subfigure[Query Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qAbstract-MAP-CLEF-IP2011}}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qExtAbstract-MAP-CLEF-IP2011}}\subfigure[Query Description.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qDescription-MAP-CLEF-IP2011}}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qTitle-PRES-CLEF-IP2011}
}\subfigure[Query Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qAbstract-PRES-CLEF-IP2011}
}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qExtAbstract-PRES-CLEF-IP2011}
}\subfigure[Query Description.]{\includegraphics[width=4.37cm]{Results-CIKM2014/qDescription-PRES-CLEF-IP2011}
}
\par\end{centering}
...
\end{itemize}
\begin{figure*}
\centering{}\includegraphics[width=17.5cm]{img/legendQR3}
\end{figure*}
...
\begin{figure}
\begin{centering}
\subfigure[\scriptsize Q. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qAbstract-MAP-CLEF-IP2010}
}\subfigure[\scriptsize Q. Ext. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qExtAbstract-MAP-CLEF-IP2010}
}\subfigure[\scriptsize Q. Description.]{\includegraphics[width=2.7cm]{mmrqrResults/qDescription-MAP-CLEF-IP2010}
}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\subfigure[\scriptsize Q. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qAbstract-PRES-CLEF-IP2010}
}\subfigure[\scriptsize Q. Ext. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qExtAbstract-PRES-CLEF-IP2010}
}\subfigure[\scriptsize Q. Description.]{\includegraphics[width=2.7cm]{mmrqrResults/qDescription-PRES-CLEF-IP2010}
}
\par\end{centering}
...
\begin{figure}[t]
\begin{centering}
\subfigure[\scriptsize Q. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qAbstract-MAP-CLEF-IP2011}
}\subfigure[\scriptsize Q. Ext. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qExtAbstract-MAP-CLEF-IP2011}
}\subfigure[\scriptsize Q. Description.]{\includegraphics[width=2.7cm]{mmrqrResults/qDescription-MAP-CLEF-IP2011}
}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\subfigure[\scriptsize Q. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qAbstract-PRES-CLEF-IP2011}
}\subfigure[\scriptsize Q. Ext. Abstract.]{\includegraphics[width=2.7cm]{mmrqrResults/qExtAbstract-PRES-CLEF-IP2011}
}\subfigure[\scriptsize Q. Description.]{\includegraphics[width=2.7cm]{mmrqrResults/qDescription-PRES-CLEF-IP2011}
}
\par\end{centering}
...
Also, Xue and Croft \cite{Xue2009} advocates the use of the full
patent application as the query to reduce the burden on patent examiners.
They conducted a series of experiments in order to examine the effect
of different patent fields, and concludes with the observation that
the best Mean Average Precision (MAP) is achieved using the text from
the description section of the query patent with raw term frequencies.
Also, Fuji \cite{Fujii2007} showed that retrieval effectiveness can
be improved by combining IR methods with the result of citation extraction.
In \cite{Mona2015}, the authors tried simple automated approaches
for query reduction but were unable to improve the baseline. However,
they have shown that a simple, minimal interactive relevance feedback
approach outperforms the best result from CLEF-IP 2010 suggesting
the promise of interactive methods for term selection in patent prior
art search.
...
Lastly, a more recent work by Mahdabi et al. \cite{Mahdabi2014a}
...
cited documents together with the publication dates. In \cite{Mahdabi2014b}
...
expand the original query. Finally, in \cite{Mahdabi2014c} authors
propose a method based on a random walk in a network of patent citations,
to find influential documents in the citation network of a query patent,
which can serve as candidates for drawing query terms and bigrams
...
\subfour{Acknowledgements:} NICTA is funded by the Australian Government
as represented by the Department of Broadband, Communications and
the Digital Economy and the Australian Research Council through the
ICT Centre of Excellence program. Experiments presented in this paper
...
Universities as well as other organizations (see \texttt{https://www.grid5000.fr}).

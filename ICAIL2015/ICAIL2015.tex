...
methods that we evaluate in Section \ref{sec:Evaluation}.
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=6cm]{Results-CIKM2014/qTitle-MAP-CLEF-IP2010}}\subfigure[Query Abstract.]{\includegraphics[width=6cm]{Results-CIKM2014/qAbstract-MAP-CLEF-IP2010}}
\par\end{centering}

\begin{centering}
\subfigure[Query Claims.]{\includegraphics[width=6cm]{Results-CIKM2014/qClaims-MAP-CLEF-IP2010}
}\subfigure[Query Description.]{\includegraphics[width=6cm]{Results-CIKM2014/qDescription-MAP-CLEF-IP2010}}
\par\end{centering}

\protect\caption{MAP for QE methods on CLEF-IP 2010.}


\label{fig:MAP-CLEF2010}\label{fig:qDescription-MAP-CLEF-IP2010}
\end{figure*}
...
\begin{centering}
\subfigure[Query Claims.]{\includegraphics[width=6cm]{Results-CIKM2014/qClaims-PRES-CLEF-IP2010}
...
\label{fig:PRES-CLEF2010} \label{fig:qDescription-PRES-CLEF-IP2010}
\end{figure*}
...
}\subfigure[Query Claims.]{\includegraphics[width=4cm]{mmrqrResults/qClaims-MAP-CLEF-IP2010}
...
}\subfigure[Query Claims.]{\includegraphics[width=4cm]{mmrqrResults/qClaims-PRES-CLEF-IP2010}

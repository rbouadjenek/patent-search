...
of six terms, the other sections are longer, ranging from tens to
...
In the following sections, we first give a motivation behind using
query reduction for patent search in Section \ref{sec:UtilityQR}.
...
the description section. Recall that we don't consider the Claim section,
...
QR methods are helpful. First, we notice that even if there is common
...
in comparison to patent-specific methods using specialized expansion

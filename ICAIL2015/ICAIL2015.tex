...
the title, the abstract, the description section, and an extended
abstract (which we consider as the 5 first paragraphs of the description
section), while we consider the claims section to be more likely to
be written by a patent attorney.
...
with that section? We assume the writing effort to be a function of
word number.
\item In query expansion, which patent section is the better source for
term expansion? %do any sections of patents serve as better sources of expansion terms? Which
expansion methods work best, and in which settings? 
...
and a Patent Retrieval Evaluation Score (PRES)%
...
removed from the query, we increase PRES of the original long query.
...
\hline 
\textbf{\scriptsize{}medic...} & {\scriptsize{}0.400} & {\scriptsize{}0.300} & {\scriptsize{}0.428} & \textbf{\scriptsize{}0.297} & \textbf{\scriptsize{}0.787}\tabularnewline
\hline 
...
\begin{figure}[!h]
\begin{centering}
\includegraphics[width=4.3cm]{analysis/precision-recall_ByField-CLEF-IP_2010}\includegraphics[width=4.3cm]{analysis/MAP-MRR_ByField-CLEF-IP_2010}
...
\begin{figure}[!t]
\begin{centering}
\includegraphics[width=7cm]{img/matrix} 
\par\end{centering}
...
a query can be reduced as follows: %one can think to reduce a patent query as follows:(i)
For each patent application, take the definitions of the IPC codes
...
bad terms are those that occur few in the query, and a lot in the
class code definition). In the evaluation section we denote this approach
IPC-StopWords.
...
are the followings: %In doing this experimentation, there are many configuration options and associated questions to consider:
\begin{itemize}
...
by a lawyer than the inventor. Hence, critical questions are: what
part of a partial application an inventor should write to obtain the
best search results? And what QE methods work best for each type of
query? 
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qTitle-MAP-CLEF-IP2010}}\subfigure[Query Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qAbstract-MAP-CLEF-IP2010}}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qExtAbstract-MAP-CLEF-IP2010}}\subfigure[Query Description.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qDescription-MAP-CLEF-IP2010}}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qTitle-PRES-CLEF-IP2010}
}\subfigure[Query Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qAbstract-PRES-CLEF-IP2010}
}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qExtAbstract-PRES-CLEF-IP2010}
}\subfigure[Query Description.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qDescription-PRES-CLEF-IP2010}
}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qTitle-MAP-CLEF-IP2011}}\subfigure[Query Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qAbstract-MAP-CLEF-IP2011}}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qExtAbstract-MAP-CLEF-IP2011}}\subfigure[Query Description.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qDescription-MAP-CLEF-IP2011}}
\par\end{centering}
...
\begin{centering}
\subfigure[Query Title.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qTitle-PRES-CLEF-IP2011}
}\subfigure[Query Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qAbstract-PRES-CLEF-IP2011}
}\subfigure[Query Ext. Abstract.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qExtAbstract-PRES-CLEF-IP2011}
}\subfigure[Query Description.]{\includegraphics[width=4.5cm]{Results-CIKM2014/qDescription-PRES-CLEF-IP2011}
}
\par\end{centering}
...
abstract. Relative to the description, they take much less effort
...
abastract or the description sections. A critical question is what
...
that even there are common terms removed from the original queries
...
\begin{centering}
\subfigure[Q. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qAbstract-MAP-CLEF-IP2010}
}\subfigure[Q. Ext. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qExtAbstract-MAP-CLEF-IP2010}
}\subfigure[Q. Description.]{\includegraphics[width=3cm]{mmrqrResults/qDescription-MAP-CLEF-IP2010}
}
\par\end{centering}
...
\begin{centering}
\subfigure[Q. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qAbstract-PRES-CLEF-IP2010}
}\subfigure[Q. Ext. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qExtAbstract-PRES-CLEF-IP2010}
}\subfigure[Q. Description.]{\includegraphics[width=3cm]{mmrqrResults/qDescription-PRES-CLEF-IP2010}
}
\par\end{centering}
...
\begin{centering}
\subfigure[Q. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qAbstract-MAP-CLEF-IP2011}
}\subfigure[Q. Ext. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qExtAbstract-MAP-CLEF-IP2011}
}\subfigure[Q. Description.]{\includegraphics[width=3cm]{mmrqrResults/qDescription-MAP-CLEF-IP2011}
}
\par\end{centering}
...
\begin{centering}
\subfigure[Q. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qAbstract-PRES-CLEF-IP2011}
}\subfigure[Q. Ext. Abstract.]{\includegraphics[width=3cm]{mmrqrResults/qExtAbstract-PRES-CLEF-IP2011}
}\subfigure[Q. Description.]{\includegraphics[width=3cm]{mmrqrResults/qDescription-PRES-CLEF-IP2011}
}
\par\end{centering}
...
or IPC code definitions. For QE, future work should investigate how
can we exploit patent-specific meta-data such as inventor and citation
networks to better exploit specialized domains of discourse relevant
to patent subfields.
...
just an abstract or and extended abstract and using generic query
reformulation methods may yield the best trade-off in terms of writing
effort vs. retrieval performance. 

Finally, we believe that future work should investigate whether QE
methods for abstract queries can rival the best methods for description
queries --- if such a result were possible, it would significantly
reduce the effort required on behalf of the patent inventor to identify
potentially invalidating prior art for a new patent idea.

%Future work should investigate whether QE methods for abstract queries%can rival the best methods for description queries --- if such a result%were possible, it would significantly reduce the effort required on%behalf of the patent inventor to identify potentially invalidating%prior art for a new patent idea.
